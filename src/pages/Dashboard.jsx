    ...
    <div className="dashboard-container">
      ...
      <main className="main-content">
        ...
        <div className="topbar">
          ...
          <div className={`widget ${!isLoggedIn ? "disabled" : ""}`} onClick={() => requireLogin("/therapist-notes")}><Paperclip size={28} /><h3>Therapist Notes</h3><p>Admin recommendations Guide.</p></div>
